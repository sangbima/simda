...
use app\models\BatchKibeSearch;
...
/**
 * BatchKibeController implements the CRUD actions for BatchKibe model.
 */
class BatchKibeController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all BatchKibe models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BatchKibeSearch();
    ...
    /**
     * Displays a single BatchKibe model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing BatchKibe model.
    ...
    /**
     * Deletes an existing BatchKibe model.
    ...
    protected function autoNumber($code_main)
    {
        ...
        $model = BatchKibe::find()->where(['code_main' => $code_main])->orderBy(['code_start_num' => SORT_DESC])->one();
        if ($model) {
    ...
    /**
     * Finds the BatchKibe model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BatchKibe the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BatchKibe::findOne($id)) !== null) {
            return $model;
        } else {

...
class AnnouncementController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $model->publish_start = date('Y-m-d', strtotime($model->publish_start));
            $model->publish_end = date('Y-m-d', strtotime($model->publish_end));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->publish_start = date('d-m-Y', strtotime($model->publish_start));
            $model->publish_end = date('d-m-Y', strtotime($model->publish_end));

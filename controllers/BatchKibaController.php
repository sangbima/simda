...
use app\models\BatchKibaSearch;
...
/**
 * BatchKibaController implements the CRUD actions for BatchKiba model.
 */
class BatchKibaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all BatchKiba models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BatchKibaSearch();
    ...
    /**
     * Displays a single BatchKiba model.
     * @param integer $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->certificate_date = $model->certificate_date ? date('Y-m-d', strtotime($model->certificate_date)) : null;
            ...
            if ($model->validate()) {
                ...
                $model->certificate_date = $model->certificate_date ? date('d-m-Y', strtotime($model->certificate_date)) : null;
    ...
    /**
     * Updates an existing BatchKiba model.
    ...
    /**
     * Deletes an existing BatchKiba model.
    ...
    protected function autoNumber($code_main)
    {
        ...
        $model = BatchKiba::find()->where(['code_main' => $code_main])->orderBy(['code_start_num' => SORT_DESC])->one();
        if ($model) {
    ...
    /**
     * Finds the BatchKiba model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BatchKiba the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BatchKiba::findOne($id)) !== null) {
            return $model;
        } else {

...
use app\models\BatchKibdSearch;
...
/**
 * BatchKibdController implements the CRUD actions for BatchKibd model.
 */
class BatchKibdController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all BatchKibd models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BatchKibdSearch();
    ...
    /**
     * Displays a single BatchKibd model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing BatchKibd model.
    ...
    /**
     * Deletes an existing BatchKibd model.
    ...
    protected function autoNumber($code_main)
    {
        ...
        $model = BatchKibd::find()->where(['code_main' => $code_main])->orderBy(['code_start_num' => SORT_DESC])->one();
        if ($model) {
    ...
    /**
     * Finds the BatchKibd model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BatchKibd the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BatchKibd::findOne($id)) !== null) {
            return $model;
        } else {

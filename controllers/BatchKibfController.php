...
use app\models\BatchKibfSearch;
...
/**
 * BatchKibfController implements the CRUD actions for BatchKibf model.
 */
class BatchKibfController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all BatchKibf models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BatchKibfSearch();
    ...
    /**
     * Displays a single BatchKibf model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing BatchKibf model.
    ...
    /**
     * Deletes an existing BatchKibf model.
    ...
    protected function autoNumber($code_main)
    {
        ...
        $model = BatchKibf::find()->where(['code_main' => $code_main])->orderBy(['code_start_num' => SORT_DESC])->one();
        if ($model) {
    ...
    /**
     * Finds the BatchKibf model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BatchKibf the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BatchKibf::findOne($id)) !== null) {
            return $model;
        } else {

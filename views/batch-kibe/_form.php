                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><i class="fa fa-plus"></i> Mutasi Tambah KIB E: Aset Tetap Lainnya</div>
                                                ...
                                                'pluginEvents' => [
                                                    'change' => 'function() {
                                                        $.get("' . Url::to(['get-benefit-year', 'id'=>'']). '" + $(this).val(), function(data) {
                                                            $("#batchkibe-benefit_year").val(data.modelproductgroupsub2.benefit_year);
                                                        });
                                                        $.get("' . Url::to(['get-code-main', 'id'=>'']). '" + $("#gov_unit_id").val() +"-"+$(this).val(), function(data) {
                                                            $("#batchkibe-code_asset").val(data.codeasset);
                                                        });
                                                    }'
                                                ],
                                                'pluginOptions' => [
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                            echo $form->field($model, 'kabupatenkota_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['province_id'],
                                                    'url'=>Url::to(['/batch-kibe/listkotakab']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                            echo $form->field($model, 'kecamatan_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    ...
                                                    'url'=>Url::to(['/batch-kibe/listkecamatan']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                          echo $form->field($model, 'desakelurahan_id')->widget(DepDrop::classname(), [
                                              ...
                                              'pluginOptions'=>[
                                                  ...
                                                  'url'=>Url::to(['/batch-kibe/listdesakelurahan']),
                                              ]
                                          ]);
                                        ?>
                                    </div>
                                        ...
                                        <?= $form->field($model, 'procure_date')->widget(DatePicker::classname(),[
                                            'options' => [
                                                ...
                                                'onchange' => '
                                                    ...
                                                    $("#batchkibe-procure_year").val(sdate[2]);
                                                '
                                            ],
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                       <?= $form->field($model, 'publish_year')->widget(\yii\widgets\MaskedInput::className(),[
                                            'mask' => 'j',
                                                'definitions' => ['j' => [
                                                    'validator' => '[0-9\(\)\.\+/ ]',
                                                    'cardinality' => 4,
                                    ...
                                    <div class="col-md-8">
                                        <?php
                                            echo $form->field($model, 'room_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['gov_unit_id'],
                                                    'url'=>Url::to(['/batch-kibe/listroom']),
                                                ]
                                            ]);
                                        ?>
                                    </div>

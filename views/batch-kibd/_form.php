                                                ...
                                                'pluginEvents' => [
                                                    'change' => 'function() {
                                                        $.get("' . Url::to(['get-benefit-year', 'id'=>'']). '" + $(this).val(), function(data) {
                                                            $("#batchkibd-benefit_year").val(data.modelproductgroupsub2.benefit_year);
                                                        });
                                                        $.get("' . Url::to(['get-code-main', 'id'=>'']). '" + $("#gov_unit_id").val() +"-"+$(this).val(), function(data) {
                                                            $("#batchkibd-code_asset").val(data.codeasset);
                                                        });
                                                    }'
                                                ],
                                                'pluginOptions' => [
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                            echo $form->field($model, 'kabupatenkota_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['province_id'],
                                                    'url'=>Url::to(['/batch-kibd/listkotakab']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                            echo $form->field($model, 'kecamatan_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    ...
                                                    'url'=>Url::to(['/batch-kibd/listkecamatan']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                          echo $form->field($model, 'desakelurahan_id')->widget(DepDrop::classname(), [
                                              ...
                                              'pluginOptions'=>[
                                                  ...
                                                  'url'=>Url::to(['/batch-kibd/listdesakelurahan']),
                                              ]
                                          ]);
                                        ?>
                                    </div>
                                        ...
                                        <?= $form->field($model, 'procure_date')->widget(DatePicker::classname(),[
                                            'options' => [
                                                ...
                                                'onchange' => '
                                                    ...
                                                    $("#batchkibd-procure_year").val(sdate[2]);
                                                '
                                            ],

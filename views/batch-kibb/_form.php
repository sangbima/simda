                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><i class="fa fa-plus"></i> Mutasi Tambah KIB B: Peralatan Dan Mesin</div>
                                                ...
                                                'pluginEvents' => [
                                                    'change' => 'function() {
                                                        $.get("' . Url::to(['get-benefit-year', 'id'=>'']). '" + $(this).val(), function(data) {
                                                            $("#batchkibb-benefit_year").val(data.modelproductgroupsub2.benefit_year);
                                                        });
                                                        $.get("' . Url::to(['get-code-main', 'id'=>'']). '" + $("#gov_unit_id").val() +"-"+$(this).val(), function(data) {
                                                            $("#batchkibb-code_asset").val(data.codeasset);
                                                        });
                                                    }'
                                                ],
                                                'pluginOptions' => [
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                            echo $form->field($model, 'kabupatenkota_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['province_id'],
                                                    'url'=>Url::to(['/batch-kibb/listkotakab']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                            echo $form->field($model, 'kecamatan_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    ...
                                                    'url'=>Url::to(['/batch-kibb/listkecamatan']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                          echo $form->field($model, 'desakelurahan_id')->widget(DepDrop::classname(), [
                                              ...
                                              'pluginOptions'=>[
                                                  ...
                                                  'url'=>Url::to(['/batch-kibb/listdesakelurahan']),
                                              ]
                                          ]);
                                        ?>
                                    </div>
                                        ...
                                        <?= $form->field($model, 'procure_date')->widget(DatePicker::classname(),[
                                            'options' => [
                                                ...
                                                'onchange' => '
                                                    ...
                                                    $("#batchkibb-procure_year").val(sdate[2]);
                                                '
                                            ],
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <?= $form->field($model, 'police_no')->textInput(['maxlength' => true]) ?>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?= $form->field($model, 'legal_no')->textInput(['maxlength' => true]) ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?= $form->field($model, 'assembly_year')->widget(\yii\widgets\MaskedInput::className(),[
                                            'mask' => 'j',
                                                'definitions' => ['j' => [
                                                    'validator' => '[0-9\(\)\.\+/ ]',
                                                    'cardinality' => 4,
                                    ...
                                    <div class="col-md-8">
                                        <?php
                                            echo $form->field($model, 'room_id')->widget(DepDrop::classname(), [
                                                'type'=>DepDrop::TYPE_SELECT2,
                                                'data' => $model->roomList,
                                                'options' => ['id'=> 'room_id', 'placeholder'=>'Select ...'],
                                                'select2Options'=>[
                                                  'pluginOptions'=>[
                                                    'allowClear'=>true,
                                                  ],
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['gov_unit_id'],
                                                    'url'=>Url::to(['/batch-kibb/listroom']),
                                                ]
                                            ]);
                                        ?>
                                    </div>

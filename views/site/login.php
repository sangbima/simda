...
?>
<div class="site-login col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4">
    <div class="well">
        ...
        <?= Html::submitButton('<i class="material-icons">vpn_key</i> Login', ['class' => 'btn btn-raised btn-primary', 'name' => 'login-button']) ?>

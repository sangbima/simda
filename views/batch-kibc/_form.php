                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><i class="fa fa-plus"></i> Mutasi Tambah KIB C: Gedung Dan Bangunan</div>
                                                ...
                                                'pluginEvents' => [
                                                    'change' => 'function() {
                                                        $.get("' . Url::to(['get-benefit-year', 'id'=>'']). '" + $(this).val(), function(data) {
                                                            $("#batchkibc-benefit_year").val(data.modelproductgroupsub2.benefit_year);
                                                        });
                                                        $.get("' . Url::to(['get-code-main', 'id'=>'']). '" + $("#gov_unit_id").val() +"-"+$(this).val(), function(data) {
                                                            $("#batchkibc-code_asset").val(data.codeasset);
                                                        });
                                                    }'
                                                ],
                                                'pluginOptions' => [
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                            echo $form->field($model, 'kabupatenkota_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    'depends'=>['province_id'],
                                                    'url'=>Url::to(['/batch-kibc/listkotakab']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                            echo $form->field($model, 'kecamatan_id')->widget(DepDrop::classname(), [
                                                ...
                                                'pluginOptions'=>[
                                                    ...
                                                    'url'=>Url::to(['/batch-kibc/listkecamatan']),
                                                ]
                                            ]);
                                        ?>
                                    </div>
                                        ...
                                        <?php
                                          echo $form->field($model, 'desakelurahan_id')->widget(DepDrop::classname(), [
                                              ...
                                              'pluginOptions'=>[
                                                  ...
                                                  'url'=>Url::to(['/batch-kibc/listdesakelurahan']),
                                              ]
                                          ]);
                                        ?>
                                    </div>
                                        ...
                                        <?= $form->field($model, 'procure_date')->widget(DatePicker::classname(),[
                                            'options' => [
                                                ...
                                                'onchange' => '
                                                    ...
                                                    $("#batchkibc-procure_year").val(sdate[2]);
                                                '
                                            ],
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <?=$form->field($model, 'construction')->widget(Select2::classname(), [
                                                'data' => array('PERMANEN'=>'PERMANEN', 'SEMI PERMANEN'=>'SEMI PERMANEN', 'DARURAT'=>'DARURAT'),
                                                'options' => ['placeholder' => 'Select ...', 'id' => 'construction'],
                                                'pluginOptions' => [
                                                    'allowClear' => true
                                                ],
                                            ]);
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <?= $form->field($model, 'floor_num')->textInput(['maxlength' => true]) ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <?= $form->field($model, 'land_code_no')->textInput(['maxlength' => true]) ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                         <?= $form->field($model, 'condition')->inline()->radioList(array('BAIK'=>'BAIK', 'KURANG BAIK'=>'KURANG BAIK', 'RUSAK BERAT' => 'RUSAK BERAT'), [
                                            'class' => 'radio radio-primary'
                                        ]); ?>
                                    </div>
                                    <div class="col-md-6">

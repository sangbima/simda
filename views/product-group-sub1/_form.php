    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-plus"></i> Sub Kelompok Barang</div>
                           ...
                           <?php
                                ...
                                echo $form->field($model, 'product_area_id')->widget(DepDrop::classname(), [
                                    ...
                                    'pluginOptions'=>[
                                        ...
                                        'url'=>Url::to(['/product-group-sub1/list-product-area']),
                                ...
                                echo $form->field($model, 'product_group_id')->widget(DepDrop::classname(), [
                                    ...
                                    'select2Options'=>[
                                        ...
                                        'pluginEvents' => [
                                          'change' => 'function() {
                                                $.get("' . Url::to(['get-code-product-group', 'id'=>'']). '" + $(this).val(), function(data) {
                                                    $("#productgroupsub1-code").val(data.nextnumber);
                                                })
                                            }'
                                        ],
                                    ],
                                    'pluginOptions'=>[
                                        ...
                                        'url'=>Url::to(['/product-group-sub1/list-product-group']),

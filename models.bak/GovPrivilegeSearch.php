...
/**
 * GovPrivilegeSearch represents the model behind the search form about `app\models\GovPrivilege`.
 */
class GovPrivilegeSearch extends GovPrivilege
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'user_id', 'gov_user_id', 'province_id', 'kabupatenkota_id', 'kecamatan_id', 'desakelurahan_id'], 'integer'],

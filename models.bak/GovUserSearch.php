...
/**
 * GovUserSearch represents the model behind the search form about `app\models\GovUser`.
 */
class GovUserSearch extends GovUser
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'user_id', 'gov_main_id', 'province_id', 'kabupatenkota_id', 'kecamatan_id', 'desakelurahan_id'], 'integer'],

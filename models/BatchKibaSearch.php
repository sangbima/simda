...
class BatchKibaSearch extends BatchKiba
{
    ...
    {
        return [
            [['id', 'user_id', 'gov_unit_id', 'product_group_sub2_id', 'code_start_num', 'province_id', 'kabupatenkota_id', 'kecamatan_id', 'desakelurahan_id', 'procure_type_id', 'excomp', 'quantity', 'certificate_status'], 'integer'],
            [['created_at', 'updated_at', 'code_main', 'address', 'procure_date', 'procure_doc', 'asset_recipient', 'semester', 'description', 'land_status', 'certificate_no', 'certificate_date', 'usage', 'size_unit'], 'safe'],

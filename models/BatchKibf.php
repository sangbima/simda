...
/**
 * This is the model class for table "batch_kibf".
 *
 * @property integer $id
 ...
 */
class BatchKibf extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gov_unit_id', 'product_group_sub2_id', 'code_main', 'code_start_num', 'province_id', 'kabupatenkota_id', 'procure_date', 'procure_type_id', 'procure_doc', 'price_base', 'price_capital', 'price_total', 'quantity'], 'required'],
    ...
    {
        $datas = \app\models\ProductGroupSub2::find()->where(['like', 'code_acc', '06.%', false])->asArray()->all();

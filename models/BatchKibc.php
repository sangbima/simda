...
/**
 * This is the model class for table "batch_kibc".
 *
 * @property integer $id
 ...
 */
class BatchKibc extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['latitude', 'longitude', 'price_base', 'price_capital', 'price_total', 'land_size', 'building_size', 'floor_num'], 'number'],
            [['gov_unit_id', 'product_group_sub2_id', 'code_main', 'code_start_num', 'province_id', 'kabupatenkota_id', 'procure_date', 'procure_type_id', 'procure_doc', 'condition', 'price_base', 'price_total', 'land_status', 'land_size', 'building_size', 'construction', 'quantity', 'price_capital'], 'required'],
            [['condition', 'semester', 'description', 'construction'], 'string'],
            [['code_main', 'asset_recipient', 'size_unit'], 'string', 'max' => 45],
    ...
    {
        $datas = \app\models\ProductGroupSub2::find()->where(['like', 'code_acc', '03.%', false])->asArray()->all();

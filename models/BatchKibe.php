...
/**
 * This is the model class for table "batch_kibe".
 *
 * @property integer $id
 ...
 * @property Room $room
 */
class BatchKibe extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gov_unit_id', 'product_group_sub2_id', 'code_main', 'code_start_num', 'province_id', 'kabupatenkota_id', 'procure_date', 'procure_type_id', 'procure_doc', 'condition', 'price_base', 'price_capital', 'price_total', 'book_title', 'book_publisher', 'quantity'], 'required'],
            [['condition', 'semester', 'description', 'specification'], 'string'],
            [['code_main', 'asset_recipient', 'edition'], 'string', 'max' => 45],
            [['address', 'book_title'], 'string', 'max' => 500],
            [['procure_doc'], 'string', 'max' => 100],
            [['book_publisher', 'book_author'], 'string', 'max' => 200],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'book_publisher' => 'Nama Penerbit',
            'book_author' => 'Nama Pencipta',
            'specification' => 'Spesifikasi',
            'edition' => 'Terbitan/Edisi',
            'publish_year' => 'Tahun Cetakan',
    ...
    {
        $datas = \app\models\ProductGroupSub2::find()->where(['like', 'code_acc', '05.%', false])->asArray()->all();

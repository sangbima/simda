...
/**
 * This is the model class for table "gov_privilege".
 *
 * @property integer $id
 * @property string $created_at
 * @property string $updated_at
 * @property integer $user_id
 * @property integer $gov_user_id
...
class GovPrivilege extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'gov_user_id', 'province_id', 'kabupatenkota_id', 'kecamatan_id', 'desakelurahan_id'], 'integer'],
            [['gov_user_id', 'code', 'name', 'code_acc', 'gov_main_id'], 'required'],
            ...
            [['gov_user_id'], 'exist', 'skipOnError' => true, 'targetClass' => GovUser::className(), 'targetAttribute' => ['gov_user_id' => 'id']],
    ...
    {
        return $this->hasOne(GovUser::className(), ['id' => 'gov_user_id']);
    }
    ...
    {
        return $this->hasMany(GovUnit::className(), ['gov_privilege_id' => 'id']);
    }
